...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div class="modal-dialog">
            ...
            <input type="number" name="npm_mhs" placeholder="npm_mhs" class="form-control" required>
            <br>
            <input type="text" name="nama_mhs" placeholder="nama_mhs" class="form-control" required>
            <br>
            <input type="text" name="alamat_mhs" placeholder="alamat_mhs" class="form-control" required>
            <br>
